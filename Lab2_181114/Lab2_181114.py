...
def main():
    global FPSCLOCK, DISPLAYSURF, BASICFONT, RESET_SURF, RESET_RECT, NEW_SURF, NEW_RECT, SOLVE_SURF, SOLVE_RECT, HELP_SURF, HELP_RECT,COUNT #Барање 3
    ...
    HELP_SURF, HELP_RECT   = makeText('Help', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 120, WINDOWHEIGHT - 120) #Барање 2
            ...
            if event.type == MOUSEBUTTONUP:
                ...
                if (spotx, spoty) == (None, None):
                    ...
                    if RESET_RECT.collidepoint(event.pos):
                        ...
                        mainBoard, solutionSeq = generateNewPuzzle(10) # clicked on New Game button
                        COUNT = len(solutionSeq)
                        allMoves = []
                    elif SOLVE_RECT.collidepoint(event.pos):
                        COUNT=len(solutionSeq)+len(allMoves)
...
def drawTileRed(tilex, tiley, number, adjx=0, adjy=0):
    ...
    pygame.draw.rect(DISPLAYSURF, (255,0,0), (left + adjx, top + adjy, TILESIZE, TILESIZE))
