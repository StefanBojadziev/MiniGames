...
WINWIDTH = 960 #Барање 1
WINHEIGHT = 480 #Барање 1
...
#CAMERASLACK = 90     # ја отстрануваме оваа линија поради Барање 2
CAMERASLACK_X = 75   #Барање 2
CAMERASLACK_Y = 65   #Барање 2
...
def runGame():
    ...
    while True: # main game loop
        ...
        for sObj in squirrelObjs:
            ...
            #Барање 3
            #Проверка дали треба случајна верверичка да се движи во random правец
            if sObj['randomSquirrel']%3==0:
                sObj['y'] += sObj['movey']
            else:
                sObj['x'] += sObj['movex']
                sObj['y'] += sObj['movey']
        ...
        #Барање 2
        #Само заменуваме CAMERASLACK со CAMERASLACK_X каде станува збор за x координата
        #и CAMERASLACK со CAMERASLACK_Y каде станува збор за y координата
            ...
            for i in range(len(squirrelObjs)-1, -1, -1):
                ...
                if 'rect' in sqObj and playerObj['rect'].colliderect(sqObj['rect']):
                    ...
                    if sqObj['width'] * sqObj['height'] <= playerObj['size']**2:
                        ...
                        #Барање 4
                        #Ја користиме истата логика за зголемување како и за намалување на играчот
                        playerObj['size'] -= int((sqObj['width'] * sqObj['height']) ** 0.2) + 1
                        #playerObj['health'] -= 1 ------- мораме да го отстраниме овој ред поради Барање 4
...
def makeNewSquirrel(camerax, cameray):
    ...
    sq['randomSquirrel'] = random.randint(1, 10)  #Барање 3
